      ...
      OpenAIStream(
        ...
        })) as any,
        {
          async experimental_onFunctionCall(functionCallPayload) {
            ...
            const functionDefinition = functionsMap[functionCallPayload.name];
            if (!functionDefinition) {
              throw new Error(
                `Function ${functionCallPayload.name} is not defined.`,
              );
            }
            const zodSchema = functionDefinition.parameters;
