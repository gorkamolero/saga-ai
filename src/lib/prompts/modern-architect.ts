...
### Segment 1: [brief description of the segment]
[Segment 1 content]
\n[Segment 1 proposed asset]
\n[Asset 1 start time: ... s]
\n[Asset 1 end time: ... s]
------------------
### Segment 2: [brief description of the segment]
\n[Segment 2 content]
\n[Segment 2 proposed asset]
\n[Asset 2 start time: ... s]
\n[Asset 2 end time: ... s]
-------------------
(contd.)
...
- **Standalone**: Each image needs to be generated by itself, in isolation from the rest, so add detailed description taking into account the generator WON'T KNOW about the rest of the images. Each asset is ONE ASSET. No transitions, no montages, no sequences. Just one asset at a time.
...
- **Duration Coverage**: Ensure that you cover THE FULL DURATION of all suggested image segments covers the entire length of the and no more. You should have this information from the voiceover duration.
- **Minimum Duration**: Ensure that the suggested assets stay on screen a minimum of 4 seconds.
- **Sequential Assets**: Ensure that the suggested assets start and end times are sequential and overlap exactly. THERE CANNOT BE EMPTY SPACES, EVER
`;
