...
- **Add a little bit of context**: Each image needs to be generated by itself, in isolation from the rest, so add detailed description taking into account the generator WON'T KNOW about the rest of the images
